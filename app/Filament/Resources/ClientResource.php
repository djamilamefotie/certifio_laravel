...
class ClientResource extends Resource
{
    ...
    // N'affiche que les utilisateurs de catégorie "utilisateur" (= client)
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('categorie', 'utilisateur');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                // Champ caché pour forcer la catégorie à "utilisateur" à la création
